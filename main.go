...
func main() {
	...
	c.Handle("addidentityattributeendorsement", addIdentityAttributeEndorsement)
	...
	c.Handle("composeidentityattributeendorsement", composeIdentityAttributeEndorsement)
